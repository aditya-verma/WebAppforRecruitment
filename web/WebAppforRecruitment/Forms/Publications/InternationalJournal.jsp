...
<div class="container mt-2">
    <form id="InternationalJournal">
        <div class="form-group text-uppercase">
            ...
            <input class="form-control" id="InternationalJournal-Author" required>
        </div>
        <div class="form-group text-uppercase">
            <label for="InternationalJournal-PaperTitle">Paper Title</label>
            <input class="form-control" id="InternationalJournal-PaperTitle" required>
        </div>
        <div class="form-group text-uppercase">
            <label for="InternationalJournal-JournalName">Journal Name</label>
            <input class="form-control" id="InternationalJournal-JournalName" required>
        </div>
        <div class="form-group text-uppercase">
            <label for="InternationalJournal-Volume">Volume</label>
            <input class="form-control" id="InternationalJournal-Volume" required>
        </div>
        <div class="form-group text-uppercase">
        ...
        <div class="form-group text-uppercase">
            ...
            <input class="form-control" id="InternationalJournal-Publisher" required>
        </div>
        <div class="form-group text-uppercase">
        ...
        <div class="form-group text-uppercase">
            ...
            <div class="row" id="InternationalJournal-Co-AuthorFromDept">
                <div class="col">
                    <input id="InternationalJournal-Co-AuthorFromDept_yes" name="inlineRadioOptions" type="radio">
                    <label for="InternationalJournal-Co-AuthorFromDept_yes" class="mr-3">Yes</label>
                    <input id="InternationalJournal-Co-AuthorFromDept_no" name="inlineRadioOptions" type="radio">
