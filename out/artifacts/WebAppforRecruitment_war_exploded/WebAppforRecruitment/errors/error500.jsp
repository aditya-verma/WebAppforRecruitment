    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <div class="bg-dark rounded">
                <h3 class="text-primary text-uppercase" style="color: #FFF;padding: 1%;">HTTP Status 500 – Internal Server Error</h3>
            </div>
        </div>
    </div>
</header>
<div class="container text-center mb-5 pb-5">
    <h4>Please report to admin and try again after sometime! Thank You!</h4>
</div>
<div class="card-footer fixed-bottom mt-5" style="background-color: #c4c4c4">
