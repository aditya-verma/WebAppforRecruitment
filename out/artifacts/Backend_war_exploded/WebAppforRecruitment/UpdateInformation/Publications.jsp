    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="list-group" id="list-tab" role="tablist">
                <a class="list-group-item list-group-item-action " id="list-PersonalInfo-list" href="PersonalInformation.jsp" role="tab" >Personal Information</a>
                <a class="list-group-item list-group-item-action active" id="list-Publication-list" href="Publications.jsp" role="tab" >Publications</a>
        ...
        <div class="col-sm-8">
            <div class="tab-content" id="nav-tabContent">
                ...
                <!--------------Publication-------------->
                <div class="tab-pane fade show active" id="list-Publication" role="tabpanel" aria-labelledby="list-Publication-list">
